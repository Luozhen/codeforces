...
#ifndef CODEFORCES_TEAM_H
#define CODEFORCES_TEAM_H

#endif //CODEFORCES_TEAM_H
#include <iostream>
using namespace std;
...
// them know how to solve the second problem. That means that they will write solutions for these problems. Only Petya
// is sure about the solution for the third problem, but that isn't enough, so the friends won't take it.
//
