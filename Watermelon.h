...
#ifndef CODEFORCES_WATERMELON_H
#define CODEFORCES_WATERMELON_H

#endif //CODEFORCES_WATERMELON_H
#include <iostream>
#include <string>
#include <map>
using namespace std;
...
// out, if they can divide the watermelon in the way they want. For sure, each of them should get a part of positive
// weight.
//
//Input
...
//        YES
//Note
//        For example, the boys can divide the watermelon into two parts of 2 and 6 kilos respectively (another
// variant — two parts of 4 and 4 kilos).

string water_solution(){
    int weight;
    cin >> weight;
    return (weight < 3|weight % 2)?"NO":"YES";
}